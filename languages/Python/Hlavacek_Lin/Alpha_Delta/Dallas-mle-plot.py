...
temp1 = load('/Users/amallela/Documents/bmab/inferences/Dallas4-n5-parLog.npy')
temp2 = load('/Users/amallela/Documents/bmab/inferences/Dallas4-n5-logLLog.npy')
...
fig.tight_layout()
plt.savefig('Dallas-mle-plot.pdf',dpi=1200)
plt.close()