function ydot = EquationsDDS2(t,y)
...
ydot(1) = Q1-r1*S1(1)+d*MS1(1)-a*M*S1(1)+k*DS1(1);
ydot(2) = -S1(2)*(r1+a*M+a*D)+k*(MS1(1)+DS1(2))+d*(DS1(1)+MS1(2));
ydot(3) = -S1(3)*(r1+a*M+a*D)+k*(MS1(2)+DS1(3))+d*(DS1(2)+MS1(3));
ydot(4) = -S1(4)*(r1+a*M+a*D)+k*(MS1(3)+DS1(4))+d*(DS1(3)+MS1(4));
ydot(5:l) = -S1(5:l)*(r2+a*M+a*D)+k*(MS1(4:l-1)+DS1(5:l))+...
    d*(DS1(4:l-1)+MS1(5:l));
...
ydot(3*l+2) = Q2-r1*S2(1)+d*MS2(1)-a*M*S2(1)+k*DS2(1);
ydot(3*l+3) = -S2(2)*(r1+a*M+a*D)+k*(MS2(1)+DS2(2))+d*(DS2(1)+MS2(2));
ydot(3*l+4) = -S2(3)*(r1+a*M+a*D)+k*(MS2(2)+DS2(3))+d*(DS2(2)+MS2(3));
ydot(3*l+5) = -S2(4)*(r1+a*M+a*D)+k*(MS2(3)+DS2(4))+d*(DS2(3)+MS2(4));
ydot(3*l+6:4*l+1) = -S2(5:l)*(r2+a*M+a*D)+k*(MS2(4:l-1)+DS2(5:l))+...
    d*(DS2(4:l-1)+MS2(5:l));
...
ydot(6*l+4) = (d+k+r1)*(DS1(1)+DS1(2)+DS1(3)+DS2(1)+DS2(2)+DS2(3)) + ...
    + (d+k+r2)*(runsumDS1+runsumDS2)-a*D*(secondrunsumS1+secondrunsumS2);
end