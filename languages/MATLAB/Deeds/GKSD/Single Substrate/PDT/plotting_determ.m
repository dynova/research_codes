...
lw = 3;
hold all
g1 = plot(rvec,PDT11./PDT12,'Color','k','LineStyle',':','LineWidth',lw);
g2 = plot(rvec,PDT21./PDT22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
...
lw = 3;
hold all
k1 = plot(rvec,PDT12,'Color','k','LineStyle',':','LineWidth',lw);
k2 = plot(rvec,PDT22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
set(ax,'FontSize',16,'FontWeight','bold','LineWidth',3,...
