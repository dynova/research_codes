...
lw = 3;
hold all
g1 = plot(rvec,PDS11./PDS12,'Color','k','LineStyle',':','LineWidth',lw);
g2 = plot(rvec,PDS21./PDS22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
...
box off
hold off
export_fig PDSa -pdf -painters -transparent

figure(2)
lw = 3;
hold all
k1 = plot(rvec,PDS12,'Color','k','LineStyle',':','LineWidth',lw);
k2 = plot(rvec,PDS22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
set(ax,'FontSize',16,'FontWeight','bold','LineWidth',3,...
...
box off
hold off
export_fig PDSb -pdf -painters -transparent