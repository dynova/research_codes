...
lw = 3;
hold all
g1 = plot(rvec,DDT11./DDT12,'Color','k','LineStyle',':','LineWidth',lw);
g2 = plot(rvec,DDT21./DDT22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
...
box off
hold off
export_fig DDTa -pdf -painters -transparent

figure(2)
lw = 3;
hold all
k1 = plot(rvec,DDT12,'Color','k','LineStyle',':','LineWidth',lw);
k2 = plot(rvec,DDT22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
set(ax,'FontSize',16,'FontWeight','bold','LineWidth',3,...
...
box off
hold off
export_fig DDTb -pdf -painters -transparent