...
lw = 3;
hold all
g1 = plot(rvec,PP11./PP12,'Color','k','LineStyle',':','LineWidth',lw);
g2 = plot(rvec,PP21./PP22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
...
lw = 3;
hold all
k1 = plot(rvec,PP12,'Color','k','LineStyle',':','LineWidth',lw);
k2 = plot(rvec,PP22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
set(ax,'FontSize',16,'FontWeight','bold','LineWidth',3,...
