...
lw = 3;
hold all
g1 = plot(rvec,DP11./DP12,'Color','k','LineStyle',':','LineWidth',lw);
g2 = plot(rvec,DP21./DP22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
...
box off
hold off
export_fig DPa -pdf -painters -transparent

figure(2)
lw = 3;
hold all
k1 = plot(rvec,DP12,'Color','k','LineStyle',':','LineWidth',lw);
k2 = plot(rvec,DP22,'Color','k','LineStyle','-','LineWidth',lw);
ax = gca;
set(ax,'FontSize',16,'FontWeight','bold','LineWidth',3,...
...
box off
hold off
export_fig DPb -pdf -painters -transparent