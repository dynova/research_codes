...
%% Begin loop code
for n = 1:alpha
    eta_1 = (n-1)./(20*(alpha-1));
    eta_11(n) = (n-1)./(20*(alpha-1));
    
    for m = 1:alpha
        eta_2 = (m-1)./(20*(alpha-1));
        eta_22(m) = (m-1)./(20*(alpha-1));
...
colorbar;
annotation(figure(1),'line',[0.15 0.760714285714286],...
    [0.114285714285714 0.923809523809524],'LineStyle','--','LineWidth',2);
annotation(figure(1),'line',[0.760714285714286 0.148214285714286],...
    [0.114285714285714 0.921428571428571],'LineStyle','--','LineWidth',2);
...
ylabel('$\eta_2$','Interpreter','LaTex','FontSize',16);
colorbar;
annotation(figure(2),'line',[0.15 0.760714285714286],...
    [0.114285714285714 0.923809523809524],'LineStyle','--','LineWidth',2);
annotation(figure(2),'line',[0.760714285714286 0.148214285714286],...
    [0.114285714285714 0.921428571428571],'LineStyle','--','LineWidth',2);
...
ylabel('$\eta_2$','Interpreter','LaTex','FontSize',16);
colorbar;
annotation(figure(3),'line',[0.15 0.760714285714286],...
    [0.114285714285714 0.923809523809524],'LineStyle','--','LineWidth',2);
annotation(figure(3),'line',[0.760714285714286 0.148214285714286],...
    [0.114285714285714 0.921428571428571],'LineStyle','--','LineWidth',2);
...
ylabel('$\eta_2$','Interpreter','LaTex','FontSize',16);
colorbar;
annotation(figure(4),'line',[0.15 0.760714285714286],...
    [0.114285714285714 0.923809523809524],'LineStyle','--','LineWidth',2);
annotation(figure(4),'line',[0.760714285714286 0.148214285714286],...
    [0.114285714285714 0.921428571428571],'LineStyle','--','LineWidth',2);