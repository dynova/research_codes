...
mfpt = zeros(len_d,len_b,len_a,len_h,len_l,len_t);
count = 0;
            ...
            for ind_h = a+1:n
                ...
                for ind_l = 1:a-1
                    ...
                    for ind_t = 1:len_t
                        ...
                        initial = arr_start(t);
                        final = arr_end(t);
                        Q = generator(b1,b2,b3,d,n,Q_size);
                        Q(1,:) = [];
                        Q(:,1) = [];
                        p0 = zeros(Q_size,1);
                        p0(initial) = 1;
                        p0(1) = [];
                        v = -Q\p0;
                        mfpt(ind_d,ind_b,ind_a,ind_h,ind_l,ind_t) = sum(v)-v(final-1);
                        count = count + 1;
%                         disp(count)
...
e58 = r(:,:,:,:,:,23);
e85 = r(:,:,:,:,:,24);
save NLine.mat e12 e21 e23 e32 e34 e43 e45 e54 e56 e65 e67 e76 e18 e81 e16 e61 e27 e72 e38 e83 e47 e74 e58 e85;
end

function Q = generator(b1,b2,b3,d,n,Q_size)
f = @(x,y,z) (n+1)^2*x+(n+1)*y+z+1;
Qnz = 0;
tau = 6/n^2;
alph = 4/n;
